...
def web3() -> Web3:
    ...
    register_keys(web3,
                  ["key_file=test/config/keys/UnlimitedChain/key1.json,pass_file=/dev/null",
                   "key_file=test/config/keys/UnlimitedChain/key2.json,pass_file=/dev/null",
                   "key_file=test/config/keys/UnlimitedChain/key3.json,pass_file=/dev/null",
                   "key_file=test/config/keys/UnlimitedChain/key4.json,pass_file=/dev/null",
                   "key_file=test/config/keys/UnlimitedChain/key.json,pass_file=/dev/null"])
